 ...
 *
 */
public class CSD_Performance_MUISearch_Page_Action {
...
private static ExtentTest logger = null;
	...
	public CSD_Performance_MUISearch_Page_Action(ExtentTest logger) {
		this.logger = logger;
	}
	...
	public static void ExecuteJMeter(int loopCount, int userThreads) throws Exception {
        ...
        if (jmeterHome.exists()) {
            ...
            if (jmeterProperties.exists()) {
                ...
                String script_4 =       "var pkg = JavaImporter(org.openqa.selenium, org.openqa.selenium.support.ui)\n"+
                	    "var support_ui = JavaImporter(org.openqa.selenium.support.ui.WebDriverWait)\n"+
                	    "var wait = new support_ui.WebDriverWait(WDS.browser, 5000)\n"+
                	    "java.lang.Thread.sleep(5000)\n"+
                	    "java.lang.Thread.sleep(5000)\n"+
                	    "WDS.log.info(\"Inside MUI-Search !\")\n"+
                	    "wait.until(pkg.ExpectedConditions.presenceOfElementLocated(pkg.By.xpath(\"//*[@test-id='search-btn']\")))\n"+// -- ////*[@test-id='ppa-point-row-equipment-name']
                	    "var search =WDS.browser.findElement(pkg.By.xpath(\"//*[@test-id='search-btn']\"))\n"+ ///a
                	    "WDS.log.info(\"MUI-Search --- 1 !\")\n"+
                	    "search.click()\n"+
                	    "wait.until(pkg.ExpectedConditions.presenceOfElementLocated(pkg.By.xpath(\"//*[@test-id='search-input-field']\")))\n"+// -- ////*[@test-id='ppa-point-row-equipment-name']
                	    "var search_txt =WDS.browser.findElement(pkg.By.xpath(\"//*[@test-id='search-input-field']\"))\n"+//test-id='search-input-field'
                	    "search_txt.sendKeys('${search_text}')\n"+
                	    "WDS.sampleResult.sampleStart()\n"+
                	    "WDS.log.info(\"MUI-Search --- 2 !\")\n"+
                	    "wait.until(pkg.ExpectedConditions.presenceOfElementLocated(pkg.By.xpath(\"//*[@test-id='search-dropdown-equip-icon']\")))\n"+// -- ////*[@test-id='ppa-point-row-equipment-name']
                	    "var search_txt_res =WDS.browser.findElement(pkg.By.xpath(\"//*[@test-id='search-dropdown-equip-icon']\"))\n"+//test-id='search-dropdown-equip-icon'
                	    "if(!search_txt_res.empty)\n"+ 
                	    "{\n"+
                	        //WDS.sampleResult.subSampleEnd(true)
                	        "WDS.sampleResult.sampleEnd()\n"+
                	        "WDS.log.info(\"WEBPAGE IS LOADED!\")\n"+
                ...
                sample_WDS.setName("MUI Search!");
                sample_WDS.setScriptLanguage("javascript");
                sample_WDS.setEnabled(true);
                sample_WDS.setScript(script+script_2+script_4);
               ...
               // try {
				...
				logger.log(LogStatus.INFO, "Summary Details "+summer.getComment());
