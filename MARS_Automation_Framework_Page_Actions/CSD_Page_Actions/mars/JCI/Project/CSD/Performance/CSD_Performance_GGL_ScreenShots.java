 ...
 *
 */
public class CSD_Performance_GGL_ScreenShots {
	
	private static ExtentTest logger = null;
	public static List<String> gglGraphsList = new ArrayList<String>();
	public static String gglGraphsLoacation = "C:/MARS_FRAMEWORK/MARS_Automation_Framework_Tests/GraphsGeneratorListenerResult";
	
	@SuppressWarnings("static-access")
	public CSD_Performance_GGL_ScreenShots(ExtentTest logger) {
		this.logger = logger;
	}
	...
	public static String addGGLGraphsToReport(ExtentTest logger_1) {
