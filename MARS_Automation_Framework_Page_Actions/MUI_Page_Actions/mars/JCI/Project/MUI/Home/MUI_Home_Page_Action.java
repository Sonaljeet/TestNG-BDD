...
public class MUI_Home_Page_Action {

	private WebDriver driver = null;
	private ExtentTest logger = null;
	private WebElement element = null;
	
	public MUI_Home_Page_Action(WebDriver driver, ExtentTest logger) {
		this.logger = logger;
		this.driver = driver;
	}
	...
	public boolean isUserMenuPresent() {
		...
		MUI_Home_Page_Factory homePF = new MUI_Home_Page_Factory(driver, logger);
