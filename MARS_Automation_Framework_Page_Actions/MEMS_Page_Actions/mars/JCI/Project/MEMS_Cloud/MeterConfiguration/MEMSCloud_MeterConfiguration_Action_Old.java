...
import mars.JCI.Project.MEMSCloud.MeterConfiguration.MEMSCloud_MeterConfiguration_Page_Factory_Old;
import mars.JCI.Project.MEMS_Cloud.Orgnization.MEMSCloud_Orgnization_Action;

public class MEMSCloud_MeterConfiguration_Action_Old {
	/** The ExtentTest logger. */
	private static ExtentTest logger;
	public static MEMSCloud_Orgnization_Action orgnizaton_action_obj = null;
	private static MEMSCloud_MeterConfiguration_Page_Factory_Old MeterConfig = null;
	 ...
	 *            the logger
	 */
	public MEMSCloud_MeterConfiguration_Action_Old(WebDriver driver, ExtentTest logger) {
		this.driver = driver;
		this.logger = logger;
		orgnizaton_action_obj = new MEMSCloud_Orgnization_Action(driver, logger);
		MeterConfig = new MEMSCloud_MeterConfiguration_Page_Factory_Old(driver, logger);
		// PageFactory.initElements(driver, this);
	}

	public void waitForLoginUser() throws Exception {
		MEMSCloud_MeterConfiguration_Page_Factory_Old PortfolioPF = new MEMSCloud_MeterConfiguration_Page_Factory_Old(driver,
				logger);
	...
	public void createOnlineMeter() throws Exception {
		...
		MEMSCloud_MeterConfiguration_Page_Factory_Old MeterConfig = new MEMSCloud_MeterConfiguration_Page_Factory_Old(driver,
				logger);
