package mars.JCI.Project.DES.PS_PointMapping;
...
public class DES_PS_PointMapping_Factory {
	public static WebDriver driver;
	public static ExtentTest logger;
	
	public DES_PS_PointMapping_Factory(WebDriver driver, ExtentTest logger){
		this.driver=driver;
		this.logger=logger;
	...
	@FindBy(css="a[automation-id='psPointMapping']")
	WebElement psPointMappingTab;
	
	public WebElement getpsPointMappingTab() {
		WebElement element = null;
		if (WebElementCommon.waitForElementPresent(driver, psPointMappingTab, logger) == true) {
			element = psPointMappingTab;
		}
		return element;
	}
