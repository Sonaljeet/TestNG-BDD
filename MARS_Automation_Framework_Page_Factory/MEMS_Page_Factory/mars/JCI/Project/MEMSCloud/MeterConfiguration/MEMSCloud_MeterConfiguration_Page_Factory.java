...
public class MEMSCloud_MeterConfiguration_Page_Factory {
	 ...
	 *            the logger
	 */
	public MEMSCloud_MeterConfiguration_Page_Factory(WebDriver driver, ExtentTest logger) {
		this.driver = driver;
		this.logger = logger;
	...
	// *************** ADD ONLINE POINT RADIO BUTTON
	@FindBy(xpath = "//input[@id='sbMeterAdd']")
	private WebElement AddOnlinePointRadioBtn;

	public WebElement getAddOnlinePointRadioBtn() {
		commonFunctions.WebElementCommon.staticWait(300);
		if (commonFunctions.WebElementCommon.waitForElementPresent(driver, AddOnlinePointRadioBtn, logger) == true) {
			return AddOnlinePointRadioBtn;
		} else
			return null;
	}

	// *************** SELECT METER ONLINE POINT WEBELEMENT
	public List<WebElement> selectOnlinePoint = null;

	public List<WebElement> getselectOnlinePoint(String pointName) throws InterruptedException {
		selectOnlinePoint = driver.findElements(By.xpath("//div[text()='" + pointName
				+ "'][@class='weather-data-source-node-icon ng-binding']//parent::div/input"));
		System.out.println("selectOnlinePoint : " + selectOnlinePoint);
		return selectOnlinePoint;
	}
	
	// *************** ADD ONLINE POINT RADIO BUTTON
	@FindBy(xpath = "//label[@class='radio-inline']/input[@value='virtualpoint']")
	private WebElement AddVirtualPointRadioBtn;

	public WebElement getAddVirtualPointRadioBtn() {
		commonFunctions.WebElementCommon.staticWait(300);
		if (commonFunctions.WebElementCommon.waitForElementPresent(driver, AddVirtualPointRadioBtn, logger) == true) {
			return AddVirtualPointRadioBtn;
		} else
			return null;
	}

	// *************** POINT NAME WEBELEMENT
	@FindBy(xpath = "(//div[@class='col-xs-12 margin-top-10']/span/input[@placeholder='Enter point name'])[2]")
	private WebElement VirtualpointName_UnderOnlineMeter;

	public WebElement getVirtualpointName_UnderOnlineMeter() {
		commonFunctions.WebElementCommon.staticWait(300);
		if (commonFunctions.WebElementCommon.waitForElementPresent(driver, VirtualpointName_UnderOnlineMeter,
				logger) == true) {
			return VirtualpointName_UnderOnlineMeter;
		} else
			return null;
	}
	...
	// *************** ENTER DESCRIPTION WEBELEMENT
	@FindBy(xpath = "(//input[@placeholder='Enter description'])[2]")
	private WebElement enterVirtualDesc_UnderOnlineMet;

	public WebElement getEnterVirtualDesc_UnderOnlineMet() {
		commonFunctions.WebElementCommon.staticWait(300);
		if (commonFunctions.WebElementCommon.waitForElementPresent(driver, enterVirtualDesc_UnderOnlineMet,
				logger) == true) {
			return enterVirtualDesc_UnderOnlineMet;
		} else
			return null;
	}

	// *************** UNIT TYPE WEBELEMENT
	@FindBy(xpath = "(//select[@name='unitType'])[3]")
	private WebElement unitType_VirPt_Under_OnlineMet;

	public WebElement getunitType_VirPt_Under_OnlineMet() {
		commonFunctions.WebElementCommon.staticWait(300);
		if (commonFunctions.WebElementCommon.waitForElementPresent(driver, unitType_VirPt_Under_OnlineMet,
				logger) == true) {
			return unitType_VirPt_Under_OnlineMet;
		} else
			return null;
	}
	...
	// *************** UNIT WEBELEMENT
	@FindBy(xpath = "(//select[@name='pointunit'])[2]")
	private WebElement unit_VirMet_Under_OnlineMet;

	public WebElement getUnit_VirMet_Under_OnlineMet() {
		commonFunctions.WebElementCommon.staticWait(300);
		if (commonFunctions.WebElementCommon.waitForElementPresent(driver, unit_VirMet_Under_OnlineMet,
				logger) == true) {
			return unit_VirMet_Under_OnlineMet;
		} else
			return null;
	}

	// *************** POINT ROLE WEBELEMENT
	@FindBy(xpath = "(//select[@name='pointRole'])[3]")
	private WebElement pointRole_VirMet_Under_OnlineMet;

	public WebElement getpointRole_VirMet_Under_OnlineMet() {
		commonFunctions.WebElementCommon.staticWait(300);
		if (commonFunctions.WebElementCommon.waitForElementPresent(driver, pointRole_VirMet_Under_OnlineMet,
				logger) == true) {
			return pointRole_VirMet_Under_OnlineMet;
		} else
			return null;
	}

	// *************** POINT ROLE WEBELEMENT
	@FindBy(xpath = "(//select[@name='seriestype'])[3]")
	private WebElement seriesType_VirMet_Under_OnlineMet;

	public WebElement getseriesType_VirMet_Under_OnlineMet() {
		commonFunctions.WebElementCommon.staticWait(300);
		if (commonFunctions.WebElementCommon.waitForElementPresent(driver, seriesType_VirMet_Under_OnlineMet,
				logger) == true) {
			return seriesType_VirMet_Under_OnlineMet;
		} else
			return null;
	}
	
	// *************** VIRTUAL POINT DEFINATION WEBELEMENT
	@FindBy(xpath = "(//button[@id='launchVirtualMeterModal'])[2]")
	private WebElement VirtualPointDef_Under_OnlineMet;

	public WebElement getVirtualPointDef_Under_OnlineMet() {
		commonFunctions.WebElementCommon.staticWait(1000);
		if (commonFunctions.WebElementCommon.waitForElementPresent(driver, VirtualPointDef_Under_OnlineMet,
				logger) == true) {
			return VirtualPointDef_Under_OnlineMet;
		} else
			return null;
	}
	
	// *************** VIRTUAL POINT EXPAND BUILDING TREE WEBELEMENT
		public List<WebElement> expandBuildingTree_VirPopUp_Plus = null;

		public List<WebElement> getexpandBuildingTree_VirPopUp_Plus(String locationName) throws InterruptedException {
			System.out.println("locationName : " + locationName);
			//expandBuildingTree_VirPopUp_Plus = driver.findElements(By.xpath("(//div[text()='" + locationName + "']//ancestor::div[@class='space-tree-node ng-scope angular-ui-tree-handle']//a//span[@class='glyphicon tree-plus-icon-small']))[3]"));
			expandBuildingTree_VirPopUp_Plus = driver.findElements(By.xpath("(//div[text()='" + locationName + "']//ancestor::div[@class='space-tree-node ng-scope angular-ui-tree-handle']//a//span[@class='glyphicon tree-plus-icon-small'])[3]"));
			//expandBuildingTree_VirPopUp_Plus = driver.findElements(By.xpath("(//div[text()='TestAutoBuilding']//ancestor::div[@class='space-tree-node ng-scope angular-ui-tree-handle']//a//span[@class='glyphicon tree-plus-icon-small'])[3]"));
			System.out.println("expandBuildingTree_VirPopUp_Plus : " + expandBuildingTree_VirPopUp_Plus);
			return expandBuildingTree_VirPopUp_Plus;
		}
			
		// *************** VIRTUAL POINT EXPAND BUILDING TREE WEBELEMENT
		public List<WebElement> expandBuildingTree_VirPopUp_Minus = null;

		public List<WebElement> getexpandBuildingTree_VirPopUp_Minus(String locationName) throws InterruptedException {
			System.out.println("locationName : " + locationName);
			//expandBuildingTree_VirPopUp_Minus = driver.findElements(By.xpath("(//div[text()='" + locationName + "']//ancestor::div[@class='space-tree-node ng-scope angular-ui-tree-handle']//a//span[@class='glyphicon tree-minus-icon-small']))[2]"));
			expandBuildingTree_VirPopUp_Minus = driver.findElements(By.xpath("(//div[text()='" + locationName + "']//ancestor::div[@class='space-tree-node ng-scope angular-ui-tree-handle']//a//span[@class='glyphicon tree-minus-icon-small'])[2]"));
			System.out.println("expandBuildingTree_VirPopUp_Minus : " + expandBuildingTree_VirPopUp_Minus);
			return expandBuildingTree_VirPopUp_Minus;
		}

	// *************** VIRTUAL POINT EXPAND BUILDING TREE WEBELEMENT
	public List<WebElement> expandCommodityTree_VirPopUp_Minus = null;

	public List<WebElement> getexpandCommodityTree_VirPopUp_Minus(String buildingName, String commodityName)
			throws InterruptedException {
		System.out.println("BuildingName : " + buildingName + "  CommodityName : " + commodityName);
		expandCommodityTree_VirPopUp_Minus = driver.findElements(By.xpath("(//div[text()='" + buildingName
				+ "'])[3]//parent::div//parent::div//parent::li//div[text()='" + commodityName
				+ "']//parent::div//preceding-sibling::a/span[@class='glyphicon tree-minus-icon-small']"));
		System.out.println("expandCommodityTree_VirPopUp_Minus : " + expandCommodityTree_VirPopUp_Minus);
		return expandCommodityTree_VirPopUp_Minus;
	}

	// *************** VIRTUAL POINT EXPAND BUILDING TREE WEBELEMENT
	public List<WebElement> expandCommodityTree_VirPopUp_Plus = null;

	public List<WebElement> getexpandCommodityTree_VirPopUp_Plus(String buildingName, String commodityName)
			throws InterruptedException {
		System.out.println("BuildingName : " + buildingName + "  CommodityName : " + commodityName);
		expandCommodityTree_VirPopUp_Plus = driver.findElements(By.xpath("(//div[text()='" + buildingName
				+ "'])[3]//parent::div//parent::div//parent::li//div[text()='" + buildingName
				+ "']//parent::div//preceding-sibling::a/span[@class='glyphicon tree-plus-icon-small']"));
		System.out.println("expandCommodityTree_VirPopUp_Plus : " + expandCommodityTree_VirPopUp_Plus);
		return expandCommodityTree_VirPopUp_Plus;
	}

	// *************** VALIDATE SYNTAX WEBELEMENT
	@FindBy(xpath = "(//button[text()='Save'][@class='btn btn-primary smallbtn ng-scope'])[3]")
	private WebElement SaveVirtualMeterpoint_UnderOnlineMeter;

	public WebElement getSaveVirtualMeterpoint_UnderOnlineMeter() {
		commonFunctions.WebElementCommon.staticWait(300);
		if (commonFunctions.WebElementCommon.waitForElementPresent(driver, SaveVirtualMeterpoint_UnderOnlineMeter,
				logger) == true) {
			return SaveVirtualMeterpoint_UnderOnlineMeter;
		} else
			return null;
	}

	// *************** EXPAND COMMODITY TREE WEBELEMENT
	public List<WebElement> VirtualPoint_Under_OnlineMeter = null;

	public List<WebElement> getVirtualPoint_Under_OnlineMeter(String meterName) throws InterruptedException {
		Thread.sleep(1000);
		VirtualPoint_Under_OnlineMeter = driver
				.findElements(By.xpath("//div[text()='" + meterName + "'][@class='ng-binding']"));
		System.out.println("VirtualPoint_Under_OnlineMeter : " + VirtualPoint_Under_OnlineMeter);
		return VirtualPoint_Under_OnlineMeter;
	}

	// *************** SELECT METER POINT WEBELEMENT
	public List<WebElement> expandOnlineMeterPoint = null;

	public List<WebElement> getexpandOnlineMeterPoint(String pointName) throws InterruptedException {
		expandOnlineMeterPoint = driver.findElements(By.xpath("(//div[text()='" + pointName
				+ "']//ancestor::div[@class='space-tree-node ng-scope angular-ui-tree-handle selected']//a//span)[1]"));
		System.out.println("expandOnlineMeterPoint : " + expandOnlineMeterPoint);
		return expandOnlineMeterPoint;
	}
