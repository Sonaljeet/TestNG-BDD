...
public class GraphicalReporter implements IReporter {
    private ExtentReports extent;
 
    @Override
    public void generateReport(List<XmlSuite> xmlSuites, List<ISuite> suites, String outputDirectory) {
    	outputDirectory = "C:\\MARS_FRAMEWORK\\MARS_Automation_Framework_Reports\\mars\\JCI\\Project\\DES\\HTML_Report";
