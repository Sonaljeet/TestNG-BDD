...
public interface IMARSDesktopDriverCommon extends com.sun.jna.Library  {

    IMARSDesktopDriverCommon INSTANCE = (IMARSDesktopDriverCommon) Native.loadLibrary(MARSDesktopDriver.getAutoItLib(), IMARSDesktopDriverCommon.class);
    ...
    public void AU3_CDTray(WString szDrive, WString szAction);
    ...
    public int AU3_ControlSend(WString title, WString text, WString control, WString sendText);
