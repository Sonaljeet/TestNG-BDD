 ...
 * 
 */
package commonFunctionsJmeter.JMeterComponents;
 ...
 *
 */
public class JMeterHTTPSampler {
	
	private static ExtentTest logger = null;
	public static HTTPSamplerProxy ex_HTTPSampler = null;

	public JMeterHTTPSampler(ExtentTest logger) {
	...
	public static HTTPSamplerProxy setJMeterHTTPSampler(String domain_url) {
		...
		try {
			...
			ex_HTTPSampler.setName("Open Google.com");
			...
			logger.log(LogStatus.PASS, "HTTP Sampler for the JMeter Session is Set !");
		} catch (Exception e) {
