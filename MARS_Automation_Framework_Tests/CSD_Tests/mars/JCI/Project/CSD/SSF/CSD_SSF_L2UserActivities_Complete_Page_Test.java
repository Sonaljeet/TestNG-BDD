 ...
 *
 */
public class CSD_SSF_L2UserActivities_Complete_Page_Test extends BaseClass {
	

	@SuppressWarnings("static-access")
	@Parameters({"correctusername", "correctpassword" })
	@Test(priority=0,description = "Running the SSF Test Module for CSD 3.0 New Functionality Feature. Performs Activities of L2 User -- Completition of SSF Form!")
	public void validateL2UserRole_CompleteForm(String correctusername, String correctpassword){
		...
		try {
			...
			ssfImpersonatePA.checkForEditableSSFFormsUnderSearchResults_L2(true);
