 ...
 *
 */
public class CSD_SSF_L1UerActivities_Reject_Page_Test extends BaseClass{
	
	
	
	@SuppressWarnings("static-access")
	@Parameters({"correctusername", "correctpassword" })
	@Test(priority=0,description = "Running the SSF Test Module for CSD 3.0 New Functionality Feature. Performs Activities of L1 User -- Rejection of SSF Form!")
	public void validateL1UserRole_RejectForm(String correctusername, String correctpassword){
		...
		try {
			...
			ssfImpersonatePA.checkForEditableSSFFormsUnderSearchResults(false);
			...
			ssfImpersonatePA.verifyUserDeletePermissionForL1User(true);
			ssfImpersonatePA.verifyL1UserHasProperEditPermissions();
			ssfImpersonatePA.performSSFFormRejectORApproveOperation(false);
