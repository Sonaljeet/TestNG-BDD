 ...
 *
 */
public class CSD_SSF_SSFGrid_Submit_Page_Test extends BaseClass {
	
	@SuppressWarnings("static-access")
	@Parameters({"correctusername", "correctpassword" })
	@Test(priority=0,description = "Running the SSF Test Module for CSD 3.0 New Functionality Feature. Performs EDIT Action on the SSF Form created by the Branch USER")
	public void validateSSFGridFunctionalityBranchUser_EditForm(String correctusername, String correctpassword){
		...
		try {
			...
			ssfGridPageAction.searchExistingSSFBranch("Automation_TestBranch","edit",false);
			//ssfGridPageAction.validateExistingSSFBranchResult();
			//ssfGridPageAction.editExistingSSFBranchResult(true);//true -- false
			//ssfGridPageAction.verifyAutoredirectOnFormSubmit();
