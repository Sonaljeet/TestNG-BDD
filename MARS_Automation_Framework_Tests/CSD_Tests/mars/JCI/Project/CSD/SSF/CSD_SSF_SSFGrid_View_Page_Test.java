 ...
 *
 */
public class CSD_SSF_SSFGrid_View_Page_Test extends BaseClass {


	@SuppressWarnings("static-access")
	@Parameters({"correctusername", "correctpassword" })
	@Test(priority=0,description = "Running the SSF Test Module for CSD 3.0 New Functionality Feature. Performs VIEW Action on the SSF Form created by the Branch USER")
	public void validateSSFGridFunctionalityBranchUser_ViewForm(String correctusername, String correctpassword){
		...
		try {
			...
			ssfGridPageAction.searchExistingSSFBranch("Automation_TestBranch","view");
			//ssfGridPageAction.validateExistingSSFBranchResult();
			//ssfGridPageAction.viewExistingSSFForm();
