...
public class MEMS_Cloud_Orgnization_Part1_Test extends BaseClass{
	
	@Test(priority=0,description = "Create orgnization")
	public static void create_orgnization() {
		try {
			MEMSCloud_Orgnization_Action MEMS_cloud_organization_page_action = new MEMSCloud_Orgnization_Action(driver,
					logger);
			MEMS_cloud_organization_page_action.create_orgnization();
