...
public class Performance_Auto_Controller {
	...
	private final ObservableList<String> projectList = FXCollections.observableArrayList("CSD Performance Automation");
...
private String projectName = null;
	...
	private String setProjectDetailsData() {
		...
		else if (projectName != null && projectName.toUpperCase().equalsIgnoreCase("CSD Performance Automation")) {
	...
	public String testngXMlfileName = "C:\\MARS_FRAMEWORK\\MARS_Automation_Framework_Tests\\Performance_TestNG.xml";;
...
/*			if (!RunTestNgSuite.stopTest && testngXMlfileName != null) {
	...
	public void initialize1() {
		...
		ObservableList<TestCaseDetailsGridModel> testCaseName = FXCollections.observableArrayList
				(new TestCaseDetailsGridModel(true, "Running priliminary Check on the compatibility of the system !"),
				new TestCaseDetailsGridModel(true, "Load Test on CSD Application. Functionality - Login to CSD App! (4 Users/Samples)"),
				new TestCaseDetailsGridModel(true, "Checking the CTQ(Critical To Quality) Limit for the CSD SSF Tab Functionality. CTQ Limit Set is 3 Seconds"),
				new TestCaseDetailsGridModel(true, "Checking the CTQ(Critical To Quality) Limit for the CSD SSF Tab Functionality. CTQ Limit Set is 3 Seconds"),
				new TestCaseDetailsGridModel(true, "Performance Test on CSD Application. Functionality - Navigate to SSF Tab!"),
				new TestCaseDetailsGridModel(true, "Performance Test on CSD Application. Functionality - Navigate to Notification Tab!"));
